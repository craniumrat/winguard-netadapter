...
#define FILTER_FRIENDLY_NAME        L"winguard-nt-kmdf NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{70c3e659-1a7f-4951-b146-bcd650a41d92}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"winguard-nt-kmdf"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\winguard-nt-kmdf"
#define NTDEVICE_STRING             L"\\Device\\winguard-nt-kmdf"
...
DRIVER_DISPATCH winguardntkmdfDispatch;

DRIVER_DISPATCH winguardntkmdfDeviceIoControl;
